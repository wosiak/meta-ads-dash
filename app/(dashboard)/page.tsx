...
export default async function OverviewPage({ searchParams }: PageProps) {
  ...
  const [topAds, bottomAds, campaignMetrics] = await Promise.all([
    effectiveAccountId
      ? getCachedOrLiveTopAds(effectiveAccountId, dateFrom, dateTo, 5)
      : Promise.resolve([]),
    effectiveAccountId
      ? getCachedOrLiveBottomAds(effectiveAccountId, dateFrom, dateTo, 5)
      : Promise.resolve([]),
    effectiveAccountId
